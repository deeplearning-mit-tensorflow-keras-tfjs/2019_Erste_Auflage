...
const c2 = document.getElementById("copyCanvas");
...
function drawDetectedObjects(objects) {
  ...
  ctx2.drawImage(document.getElementById("myVideo"),0,0,VIDEO_WIDTH,VIDEO_HEIGHT);
  ...
  objects.forEach((object) => {
    ...
    let frame = ctx2.getImageData(object.x * VIDEO_WIDTH, object.y * VIDEO_HEIGHT, object.w * VIDEO_WIDTH, object.h * VIDEO_HEIGHT);
    ...
    */
    // $("#output").append("<div class=\"outputLine\"><b>"+ object.className  + "</b> " +  Math.round(object.classProb*100)/100 +  "%  <div class=\"mini\">" + "@ (x:"+object.x + ",y:"+object.y+")</div></div>")
  });
  objects = []
}
